    ...
    return(
        <>
            <div className="container-fluid">
                ...
                <h2 style={{marginTop:"20px",width:"76%",marginLeft:"13%"}}>ROOM FACILITY</h2>
                <NavLink to="/room/create">
                    <button type="button" className="btn btn-outline-success">Create Room</button><br/>
                </NavLink>
                <div className={"row"}>
                    {rooms.map((item) =>
