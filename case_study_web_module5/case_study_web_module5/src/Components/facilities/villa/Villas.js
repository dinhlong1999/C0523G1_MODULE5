    ...
    return(
        <>
            <div className="container-fluid">
                ...
                <h2 style={{marginTop:"20px",width:"76%",marginLeft:"13%"}}>VILLA FACILITY</h2>
                <NavLink to="/villa/create">
                    <button type="button" className="btn btn-outline-success">Create Villa</button><br/>
                </NavLink>
                <div className={"row"}>
                    {villas.map(item=>
